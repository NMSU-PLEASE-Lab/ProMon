...
#PBS -l nodes=1:ppn=16:fpga-all,walltime=30:00
...
mpirun $PROMONHOME/promon_injector DynamicInst $XMLFILES/hpc_pminput/Gadget2.xml $APPHOME/Gadget2 /nmsu/apps/Gadget-2.0.6/Gadget2/parameterfiles/galaxy.param
