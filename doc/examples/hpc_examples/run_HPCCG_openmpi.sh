...
# Torque to allocate from "nodes" (all cluster nodes), and limit 
# execution time to just 30 minutes

#PBS -l nodes=2:fpga-all,walltime=30:00
...
#mpirun /nmsu/apps/Mantevo/HPCCG-1.0/omp_mpi/test_HPCCG 100 100 50 
...
mpirun $PROMONHOME/promon_injector DynamicInst $XMLFILES/hpc_pminput/HPCCG.xml /nmsu/apps/Mantevo/HPCCG-1.0/omp_mpi/test_HPCCG 100 100 50 
