...
rm /nmsu/apps/omar_miniMD/miniMD_openmpi.promon

source $HOME/ProMon/hpc_examples/bigdat_script/pmsetup.sh /nmsu/apps/omar_miniMD/miniMD_openmpi /home/oaaziz/ProMon/hpc_pminput/miniMD.xml

START=$(date +%s.%N)
mpirun $PMEXEC -i /nmsu/apps/omar_miniMD/in.eam.miniMD 
END=$(date +%s.%N)
