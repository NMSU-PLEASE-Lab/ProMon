...
cp /home/oaaziz/ProMon/hpc_examples/bigdat_script/Test_all/script_all/progress.txt /home/oaaziz/ProMon/hpc_examples/bigdat_script/Test_all/script_all/progress_hard_new12.txt
...
for ((i=0; i<16;i++))
do
   echo `cut -d' ' -f241 /tmp/hosts.txt` >> /home/oaaziz/ProMon/hostfiles/hosts8_16.txt
done
#7
for ((i=0; i<16;i++))
do
...
for ((i=0; i<32;i++))
do
   echo `cut -d' ' -f241 /tmp/hosts.txt` >> /home/oaaziz/ProMon/hostfiles/hosts8_32.txt
done
#7
for ((i=0; i<32;i++))
do
...
START=$(date +%s.%N)
mpirun -np 16 -hostfile /home/oaaziz/ProMon/hostfiles/hosts1_16.txt $APPHOME/Gadget2 /nmsu/apps/Gadget-2.0.6/Gadget2/parameterfiles/OmarTest/cluster.param16
END=$(date +%s.%N)
...
source $HOME/ProMon/hpc_examples/bigdat_script/pmsetup.sh /nmsu/apps/Gadget-2.0.6/Gadget2/Gadget2 /home/oaaziz/ProMon/hpc_pminput/Gadget2.xml ${PROMONIP}
...
START=$(date +%s.%N)
mpirun -np 16 -hostfile /home/oaaziz/ProMon/hostfiles/hosts1_16.txt $PMEXEC /nmsu/apps/Gadget-2.0.6/Gadget2/parameterfiles/OmarTest/cluster.param16
END=$(date +%s.%N)
DIFF=$(echo "$END - $START" | bc)
...
sh /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/killit.sh
sleep 30
cp /home/oaaziz/ovis/csvstore/csv/node/nodes_agg_promoncol.csv /nmsu/omar_data/hard_Gadget16LDMS.csv
sleep 5
sh /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/remove.sh
sleep 30
ssh bigdat 'bash -s' < /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/test.sh &
...
START=$(date +%s.%N)
mpirun -np 32 -hostfile /home/oaaziz/ProMon/hostfiles/hosts2_16.txt $APPHOME/Gadget2 /nmsu/apps/Gadget-2.0.6/Gadget2/parameterfiles/OmarTest/cluster.param16
END=$(date +%s.%N)
DIFF=$(echo "$END - $START" | bc)
echo "Stand-alone time = $DIFF"
...
#source $HOME/ProMon/hpc_examples/bigdat_script/pmsetup.sh /nmsu/apps/Gadget-2.0.6/Gadget2/Gadget2 /home/oaaziz/ProMon/hpc_pminput/Gadget2.xml
...
START=$(date +%s.%N)
mpirun -np 32 -hostfile /home/oaaziz/ProMon/hostfiles/hosts2_16.txt $PMEXEC /nmsu/apps/Gadget-2.0.6/Gadget2/parameterfiles/OmarTest/cluster.param16
END=$(date +%s.%N)
DIFF=$(echo "$END - $START" | bc)
echo "Promon-LDMS time = $DIFF"
...
sh /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/killit.sh
sleep 30
cp /home/oaaziz/ovis/csvstore/csv/node/nodes_agg_promoncol.csv /nmsu/omar_data/hard_Gadget32LDMS.csv
sleep 5
sh /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/remove.sh
sleep 30
ssh bigdat 'bash -s' < /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/test.sh &
...
ProgramName="Graph500"

#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>				 16 process 		 <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

Graphfile_and_instr=/nmsu/apps/omar_g500-without-validation/mpi/graph500_mpi_simple /home/oaaziz/ProMon/hpc_pminput/Graph500_mainonly.xml ${PROMONIP}
OutputFile=/nmsu/omar_data/hard_Graph16LDMS.csv
...
echo "Start $ProgramName - 16 with Promon-Stand-alone" >> /home/oaaziz/ProMon/hpc_examples/bigdat_script/Test_all/script_all/progress.txt
START=$(date +%s.%N)
mpirun -np $NumOProc -hostfile /home/oaaziz/ProMon/hostfiles/hosts1_16.txt /nmsu/apps/omar_g500-without-validation/mpi/graph500_mpi_simple 27
END=$(date +%s.%N)
DIFF=$(echo "$END - $START" | bc)
echo "Stand-alone time = $DIFF"
echo "Stop $ProgramName - 16 with Promon-Stand-alone Time is $DIFF" >> /home/oaaziz/ProMon/hpc_examples/bigdat_script/Test_all/script_all/progress.txt
...
source $HOME/ProMon/hpc_examples/bigdat_script/pmsetup.sh /nmsu/apps/omar_g500-without-validation/mpi/graph500_mpi_simple /home/oaaziz/ProMon/hpc_pminput/Graph500_mainonly.xml ${PROMONIP}

echo "Start $ProgramName - 16 with Promon-LDMS" >> /home/oaaziz/ProMon/hpc_examples/bigdat_script/Test_all/script_all/progress.txt
START=$(date +%s.%N)
mpirun -np $NumOProc -hostfile /home/oaaziz/ProMon/hostfiles/hosts1_16.txt $PMEXEC 27
END=$(date +%s.%N)
DIFF=$(echo "$END - $START" | bc)
echo "Promon-LDMS time = $DIFF"
echo "Stop $ProgramName - 16 with Promon-LDMS Time is $DIFF" >> /home/oaaziz/ProMon/hpc_examples/bigdat_script/Test_all/script_all/progress.txt
...
sh /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/killit.sh
sleep 30
cp /home/oaaziz/ovis/csvstore/csv/node/nodes_agg_promoncol.csv /nmsu/omar_data/hard_Graph16LDMS.csv
sleep 5
sh /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/remove.sh
sleep 30
ssh bigdat 'bash -s' < /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/test.sh &
...
source $HOME/ProMon/hpc_examples/bigdat_script/pmsetup.sh /nmsu/apps/omar_g500-without-validation/mpi/graph500_mpi_simple /home/oaaziz/ProMon/hpc_pminput/Graph500_mainonly.xml ${PROMONIP} ${PROMONIP}
...
Graphfile_and_instr=/nmsu/apps/omar_g500-without-validation/mpi/graph500_mpi_simple /home/oaaziz/ProMon/hpc_pminput/Graph500_mainonly.xml
OutputFile=/nmsu/omar_data/hard_Graph32LDMS.csv
PromonFile=/nmsu/apps/omar_g500-without-validation/mpi/graph500_mpi_simple.promon
NumOProc=32
...
echo "Start $ProgramName - 32 with Promon-Stand-alone" >> /home/oaaziz/ProMon/hpc_examples/bigdat_script/Test_all/script_all/progress.txt
START=$(date +%s.%N)
mpirun -np $NumOProc -hostfile /home/oaaziz/ProMon/hostfiles/hosts2_16.txt /nmsu/apps/omar_g500-without-validation/mpi/graph500_mpi_simple 27
END=$(date +%s.%N)
DIFF=$(echo "$END - $START" | bc)
echo "Stand-alone time = $DIFF"
echo "Stop $ProgramName - 32 with Promon-Stand-alone Time is $DIFF" >> /home/oaaziz/ProMon/hpc_examples/bigdat_script/Test_all/script_all/progress.txt
...
echo "Start $ProgramName - 32 with Promon-LDMS" >> /home/oaaziz/ProMon/hpc_examples/bigdat_script/Test_all/script_all/progress.txt
START=$(date +%s.%N)
mpirun -np $NumOProc -hostfile /home/oaaziz/ProMon/hostfiles/hosts2_16.txt $PMEXEC 27
END=$(date +%s.%N)
DIFF=$(echo "$END - $START" | bc)
echo "Promon-LDMS time = $DIFF"
echo "Stop $ProgramName - 32 with Promon-LDMS Time is $DIFF" >> /home/oaaziz/ProMon/hpc_examples/bigdat_script/Test_all/script_all/progress.txt
...
sh /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/killit.sh
sleep 30
cp /home/oaaziz/ovis/csvstore/csv/node/nodes_agg_promoncol.csv /nmsu/omar_data/hard_Graph32LDMS.csv
sleep 5
sh /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/remove.sh
sleep 30
ssh bigdat 'bash -s' < /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/test.sh &
...
Graphfile_and_instr=/nmsu/apps/omar_g500-without-validation/mpi/graph500_mpi_simple /home/oaaziz/ProMon/hpc_pminput/Graph500_mainonly.xml
OutputFile=/nmsu/omar_data/hard_Graph64LDMS.csv
PromonFile=/nmsu/apps/omar_g500-without-validation/mpi/graph500_mpi_simple.promon
NumOProc=64
...
START=$(date +%s.%N)
mpirun -np $NumOProc -hostfile /home/oaaziz/ProMon/hostfiles/hosts4_16.txt /nmsu/apps/omar_g500-without-validation/mpi/graph500_mpi_simple 27
END=$(date +%s.%N)
DIFF=$(echo "$END - $START" | bc)
echo "Stand-alone time = $DIFF"
...
START=$(date +%s.%N)
mpirun -np $NumOProc -hostfile /home/oaaziz/ProMon/hostfiles/hosts4_16.txt $PMEXEC 27
END=$(date +%s.%N)
DIFF=$(echo "$END - $START" | bc)
echo "Promon-LDMS time = $DIFF"
...
sh /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/killit.sh
sleep 30
cp /home/oaaziz/ovis/csvstore/csv/node/nodes_agg_promoncol.csv /nmsu/omar_data/hard_Graph64LDMS.csv
sleep 5
sh /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/remove.sh
sleep 30
ssh bigdat 'bash -s' < /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/test.sh &
...
Graphfile_and_instr=/nmsu/apps/omar_g500-without-validation/mpi/graph500_mpi_simple /home/oaaziz/ProMon/hpc_pminput/Graph500_mainonly.xml
OutputFile=/nmsu/omar_data/hard_Graph128LDMS.csv
PromonFile=/nmsu/apps/omar_g500-without-validation/mpi/graph500_mpi_simple.promon
NumOProc=128
...
START=$(date +%s.%N)
mpirun -np $NumOProc -hostfile /home/oaaziz/ProMon/hostfiles/hosts4_32.txt /nmsu/apps/omar_g500-without-validation/mpi/graph500_mpi_simple 27
END=$(date +%s.%N)
DIFF=$(echo "$END - $START" | bc)
echo "Stand-alone time = $DIFF"
...
START=$(date +%s.%N)
mpirun -np $NumOProc -hostfile /home/oaaziz/ProMon/hostfiles/hosts4_32.txt $PMEXEC 27
END=$(date +%s.%N)
DIFF=$(echo "$END - $START" | bc)
echo "Promon-LDMS time = $DIFF"
...
sh /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/killit.sh
sleep 30
cp /home/oaaziz/ovis/csvstore/csv/node/nodes_agg_promoncol.csv /nmsu/omar_data/hard_Graph128LDMS.csv
sleep 5
sh /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/remove.sh
sleep 30
ssh bigdat 'bash -s' < /home/oaaziz/Res_svn_cook/omar/ovispublic_RC/ovis_test/MQSYSTEM5/test.sh &
